    ...
    public class Character : CharacterData
    {
            ...
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    if (Row["pos"].ToString().Contains("NaN"))
                    {
                        ...
                        if(LVL <= 1) SpawnPos = new Vector3(271.89, -323.18, 44.92); // На спавне новичков
                        else SpawnPos = new Vector3(271.89, -323.18, 44.92); // У мэрии
                    }
                }
        ...
        public async Task<int> Create(Client player, string firstName, string lastName)
        {
            try
            {
                ...
                SpawnPos = new Vector3(271.89, -323.18, 44.92);  // Спавн новичков
