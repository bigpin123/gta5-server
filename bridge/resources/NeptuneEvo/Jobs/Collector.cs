...
namespace NeptuneEvo.Jobs
{
    class Collector : Script
    {
        ...
        private static int checkpointPayment = 15;
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Взять мешок с деньгами"), TakeMoneyPos + new Vector3(0, 0, 0.3), 30f, 0.4f, 0, new Color(255, 255, 255), true, 0);
            }
        ...
        public void onPlayerExitVehicleHandler(Client player, Vehicle vehicle)
        {
            try
            {
                ...
                NAPI.Data.GetEntityData(player, "WORK") == vehicle)
                {
                    ...
                    {
                        BasicSync.AttachObjectToPlayer(player, NAPI.Util.GetHashKey("ng_proc_binbag_01a"), 18905, new Vector3(0.55, 0.02, 0), new Vector3(0, -90, 0));
        ...
        public static void rentCar(Client player)
        {
            ...
            {
                Customization.SetHat(player, 2, 0);
                player.SetClothes(11, 248, 0);
                player.SetClothes(4, 34, 0);
                player.SetClothes(6, 24, 0);
                player.SetClothes(9, 0, 1);
                player.SetClothes(8, 129, 0);
                player.SetClothes(3, Customization.CorrectTorso[true][132], 0);
            }
            else
            {
                Customization.SetHat(player, 5, 0);
                player.SetClothes(11, 256, 0);
