    ...
    class WorkManager : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16(""), new Vector3(Points[0].X, Points[0].Y, Points[0].Z + 0.5), 10F, 0.3F, 0, new Color(255, 255, 255)); //~r~Устроиться на работу
                NAPI.Marker.CreateMarker(1, Points[0] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));

                // blips
                NAPI.Blip.CreateBlip(566, new Vector3(139.11, -382.22, 43.26), 1, 4, Main.StringToU16("Сварщик"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(354, new Vector3(2280.73, 2983.34, 46.58), 1.5f, 36, Main.StringToU16("Электрики"), 255, 0, true, 0, 0);
               // NAPI.Blip.CreateBlip(408, new Vector3(105.4633, -1568.843, 28.60269), 1, 3, Main.StringToU16("Почта"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(51, new Vector3(-20.19, -1300.12, 29.24), 1, 73, Main.StringToU16("Спайс"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(631, new Vector3(462.6476, -605.5295, 27.49518), 1, 30, Main.StringToU16("Автобусник"), 255, 0, true, 0, 0);
                //NAPI.Blip.CreateBlip(512, new Vector3(-1331.475, 53.58579, 53.53268), 1, 2, Main.StringToU16("Газонокосильщик"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(635, new Vector3(588.2037, -3037.641, 6.303829), 1, 4, Main.StringToU16("Дальнобойщик"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(635, new Vector3(338.9279, 3417.426, 35.38838), 1, 4, Main.StringToU16("Дальнобойщик"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(635, new Vector3(-2212.77, 4249.193, 46.17959), 1, 4, Main.StringToU16("Дальнобойщик"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(67, new Vector3(915.9069, -1265.255, 25.52912), 1, 63, Main.StringToU16("Инкассатор"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(67, new Vector3(-1481.75537,-508.08847,31.6868382), 1, 63, Main.StringToU16("Инкассатор"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(67, new Vector3(-144.374817,6354.90869,30.3706112), 1, 63, Main.StringToU16("Инкассатор"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(446, new Vector3(473.9508, -1275.597, 29.60513), 1, 40, Main.StringToU16("Автомеханик"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(523, new Vector3(-501.78833,61.4290543,56.57218), 1, 34, Main.StringToU16("Аренда Авто"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(495, new Vector3(-1108.662, -1690.129, 3.254202), 1, 84, Main.StringToU16("Аренда Вело"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(471, new Vector3(-1625.545, -1164.137, 0.2994334), 1, 38, Main.StringToU16("Аренда Гидроцикла"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(280, new Vector3(283.19, -342.35, 44.92 ), 1, 43, Main.StringToU16("Новички"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(120, Truckers.getProduct[0], 1, 84, Main.StringToU16("Products stock"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(120, Truckers.getProduct[1], 1, 36, Main.StringToU16("Fuel stock"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(120, Truckers.getProduct[2], 1, 15, Main.StringToU16("Auto stock"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(120, Truckers.getProduct[3], 1, 62, Main.StringToU16("Guns stock"), 255, 0, true, 0, 0);
        ...
        {
            {0, new Vector3(-547.99, -191.22, 37.22) },
            {1, new Vector3(2281.31, 2983.57, 46.58) },  // Electrician job
            ...
            {9, new Vector3(139.11, -382.22, 43.26) },  // Svar
            {10, new Vector3(-21.61, -1302.15, 29.21) },  // Спайс
        };
        ...
        public static void openspaisStart(Client player)
        {
            Menu menu = new Menu("spais", false, false);
            menu.Callback = callback1_gpStartMenu;
        ...
        private static void callback1_gpStartMenu(Client client, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            if (!Main.Players.ContainsKey(client) || client.Position.DistanceTo(spais.Coords[0]) > 15)
            {
                MenuManager.Close(client);
                return;
            }
            ...
            {
                case "start":
                    if (Main.Players[client].WorkID == 10)
                    {
                        if (!NAPI.Data.GetEntityData(client, "ON_WORK"))
                        {
                            if (Houses.HouseManager.Houses.Count == 0) return;
                            ...
                            if (gender)
                            {
                                Customization.SetHat(client, 2, 0); //Головной убор 0 - стандарт цвет
                                client.SetClothes(11, 53, 0); // Верх одежда , 0 стандарт цвет
                                client.SetClothes(4, 55, 0); //Низ Штаны , 0 стандарт
                                client.SetClothes(6, 1, 0); // обувь , 0 стандарт
                                client.SetClothes(3, Core.Customization.CorrectTorso[gender][38], 0);
                            }
                            else
                            {
                            ...
                            int x = Jobs.WorkManager.rnd.Next(0, spais.spaisObjects.Count);
                            BasicSync.AttachObjectToPlayer(client, Jobs.spais.spaisObjects[x], 60309, new Vector3(0.03, 0, 0.02), new Vector3(0, 0, 50));
                        }
                        else Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы уже начали рабочий день", 3000);
                    }
                    else Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы не работаете курьером. Устроиться можно в мэрии", 3000);
                ...
                case "get":
                    {
                        ...
                        int y = Jobs.WorkManager.rnd.Next(0, Jobs.spais.spaisObjects.Count);
                        BasicSync.AttachObjectToPlayer(client, Jobs.spais.spaisObjects[y], 60309, new Vector3(0.03, 0, 0.02), new Vector3(0, 0, 50));
                        return;
                    }
                case "finish":
                    if (Main.Players[client].WorkID == 10)
