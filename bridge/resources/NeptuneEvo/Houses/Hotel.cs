    ...
    class Hotel : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                {
                    var blip = NAPI.Blip.CreateBlip(pos); // Блип отеля
                    ...
                    NAPI.TextLabel.CreateTextLabel("~r~Отель", pos + new Vector3(0, 0, 0.5), 5f, 0.4f, 0, new Color(255, 255, 255));
                    HotelID++;
                }
                ...
                foreach (var pos in CarsGet)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, pos - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));
                    NAPI.TextLabel.CreateTextLabel("~o~Скуттер Отеля", pos + new Vector3(0, 0, 0.5), 5f, 0.4f, 0, new Color(255, 255, 255));
                    HotelID++;
                }
            }
