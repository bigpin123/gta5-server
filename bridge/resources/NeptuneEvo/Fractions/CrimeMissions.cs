...
namespace NeptuneEvo.Fractions
{
    class CarDelivery : Script
    {
        ...
        private static Dictionary<int, Vector3> MafiaStartDelivery = new Dictionary<int, Vector3>()
        {
            ...
            { 12, new Vector3(-1517.91, 893.90, 181.99) }, //Мексиканская работа
            { 13, new Vector3(-1908.41, 2043.40, 139.74) }, //Армянская мафия Миссия
        };
        ...
        {
            new Vector3(-2165.107, 4285.171, 50.03421),
            new Vector3(142.6606, 6652.569, 32.59082),
            new Vector3(1427.403, 6327.671, 25.14281),
            new Vector3(1421.056, 6355.05, 25.06137),
            new Vector3(2547.709, 4645.736, 35.15304),
            new Vector3(2529.517, 4109.557, 39.75628),
            new Vector3(1404.127, 3656.653, 35.19704),
            new Vector3(1709.216, 3313.655, 42.2984),
            new Vector3(1041.522, 2650.708, 40.62605),
            new Vector3(260.4555, 2580.766, 46.11154),
        };
        private static List<Vector3> MafiaEndDelivery = new List<Vector3>()
        {
            new Vector3(-1834.286, 4692.507, 1.6031599),
            new Vector3(-2658.842, 2533.021, 2.898514),
            new Vector3(3304.526, 5401.26, 14.62714),
            new Vector3(2834.238, -724.9515, 1.6343195),
            new Vector3(1413.24, 3647.831, 34.24832),
            new Vector3(1698.02, 4873.916, 41.91091),
            new Vector3(828.0319, -3206.071, 5.78082),
            new Vector3(-337.131, -2462.448, 5.880634),
            new Vector3(1642.278, 4837.864, 41.90576),
            new Vector3(616.3151, 2799.022, 41.80243),
            new Vector3(-1151.819, -1565.433, 4.273624),
            new Vector3(1378.693, -2077.05, 51.87856),
        };
        private static Vector3 PoliceEndDelivery = new Vector3(479.2215, -1024.153, 27.91038);
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~r~Jimmy Lishman", GangStartDelivery + new Vector3(0, 0, 2.5), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                ...
                foreach (var pos in MafiaStartDelivery)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, pos.Value - new Vector3(0, 0, 2.7), new Vector3(), new Vector3(), 3, new Color(255, 18, 255), false, NAPI.GlobalDimension);
                    NAPI.TextLabel.CreateTextLabel("~h~Работа", pos.Value, 5f, 0.4f, 0, new Color(255, 255, 255));
                }
                #endregion
