...
namespace NeptuneEvo.Fractions
{
    class Fbi : Script
    {
        ...
        public static Vector3 EnterFBI = new Vector3(142.97, -735.39, 258.15);
        private static Vector3 ExitFBI = new Vector3();
        private static List<Vector3> fbiCheckpoints = new List<Vector3>()
        {
            ...
            new Vector3(141.33, -735.34, 262.85), // roof          4  -1561.171, -568.5499, 113.3084
            new Vector3(118.9617, -729.1614, 241.152), // gun menu           5
            new Vector3(136.0578, -761.8408, 44.75204), // 1 floor        6
            new Vector3(133.26, -700.41, 32.71), // lift garage       7
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~r~Секретакрь", new Vector3(149.1317, -758.3485, 243.152), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Михаил Смоков", new Vector3(120.0836, -726.7773, 243.152), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~РАБОЧИЙ ДЕНЬ"), new Vector3(fbiCheckpoints[0].X, fbiCheckpoints[0].Y, fbiCheckpoints[0].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(EnterFBI.X, EnterFBI.Y, EnterFBI.Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(ExitFBI.X, ExitFBI.Y, ExitFBI.Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[1].X, fbiCheckpoints[1].Y, fbiCheckpoints[1].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[2].X, fbiCheckpoints[2].Y, fbiCheckpoints[2].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[3].X, fbiCheckpoints[3].Y, fbiCheckpoints[3].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[4].X, fbiCheckpoints[4].Y, fbiCheckpoints[4].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~Арсенал"), new Vector3(fbiCheckpoints[5].X, fbiCheckpoints[5].Y, fbiCheckpoints[5].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[6].X, fbiCheckpoints[6].Y, fbiCheckpoints[6].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(fbiCheckpoints[7].X, fbiCheckpoints[7].Y, fbiCheckpoints[7].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~ЧП ФОРМА"), new Vector3(fbiCheckpoints[8].X, fbiCheckpoints[8].Y, fbiCheckpoints[8].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~Склад оружия"), new Vector3(fbiCheckpoints[9].X, fbiCheckpoints[9].Y, fbiCheckpoints[9].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                #endregion
            }
            ...
            try
            {
                switch (index)
                {
                    ...
                    case 5:
                        ...
                        GameLog.Stock(Main.Players[client].FractionID, Main.Players[client].UUID, "armor", 1, true);
