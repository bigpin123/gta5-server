    ...
    class Police : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~r~Денис Кров", new Vector3(452.2527, -993.119, 31.6896), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Алиса Смирнова", new Vector3(441.169, -978.3074, 31.6896), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Влад Дроздов", new Vector3(454.121, -980.0575, 31.6896), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Открыть склад"), new Vector3(policeCheckpoints[1].X, policeCheckpoints[1].Y, policeCheckpoints[1].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~Рабочий день"), new Vector3(policeCheckpoints[2].X, policeCheckpoints[2].Y, policeCheckpoints[2].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Открыть ES Меню"), new Vector3(policeCheckpoints[3].X, policeCheckpoints[3].Y, policeCheckpoints[3].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Приём сумки с оружием."), new Vector3(policeCheckpoints[7].X, policeCheckpoints[7].Y, policeCheckpoints[7].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~Открыть склад №2"), new Vector3(policeCheckpoints[8].X, policeCheckpoints[8].Y, policeCheckpoints[8].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Тюнинг орг.авто"), new Vector3(policeCheckpoints[9].X, policeCheckpoints[9].Y, policeCheckpoints[9].Z + 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
