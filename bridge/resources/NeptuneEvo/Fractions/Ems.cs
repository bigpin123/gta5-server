...
namespace NeptuneEvo.Fractions
{
    class Ems : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("~r~Вера Смирнова", new Vector3(251.4247, -1346.499, 25.5378), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Олег Вершинин", new Vector3(262.3232, -1359.772, 25.53779), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Семён Лорд", new Vector3(257.5671, -1344.612, 25.54937), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите E"), new Vector3(emsCheckpoints[0].X, emsCheckpoints[0].Y, emsCheckpoints[0].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Нажмите Е"), new Vector3(emsCheckpoints[1].X, emsCheckpoints[1].Y, emsCheckpoints[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Склад медикаментов"), new Vector3(emsCheckpoints[3].X, emsCheckpoints[3].Y, emsCheckpoints[3].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));

                col = NAPI.ColShape.CreateCylinderColShape(emsCheckpoints[4], 1, 2, 0); // duty change
                col.SetData("INTERACT", 18);
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~r~Рабочий день"), new Vector3(emsCheckpoints[4].X, emsCheckpoints[4].Y, emsCheckpoints[4].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Свести тату"), new Vector3(emsCheckpoints[6].X, emsCheckpoints[6].Y, emsCheckpoints[6].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));

                col = NAPI.ColShape.CreateCylinderColShape(new Vector3(316.47, -582.61, 43.28), 53, 7, 0); // start heal course
                ...
                NAPI.Blip.CreateBlip(535, new Vector3(3588.917, 3661.756, 41.48687), 1, 14, "Медикаменты", 255, 0, true);
                #endregion
                ...
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~В Госпиталь"), new Vector3(emsCheckpoints[7].X, emsCheckpoints[7].Y, emsCheckpoints[7].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));

                col = NAPI.ColShape.CreateCylinderColShape(emsCheckpoints[8], 1, 2, 0); // to roof
                col.SetData("INTERACT", 63);
                col.OnEntityEnterColShape += emsShape_onEntityEnterColShape;
                col.OnEntityExitColShape += emsShape_onEntityExitColShape;
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Подняться"), new Vector3(emsCheckpoints[8].X, emsCheckpoints[8].Y, emsCheckpoints[8].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
        ...
        {
            new Vector3(308.10, -590.02, 49.94), // Вход ems   +          
            new Vector3(308.10, -590.02, 49.94),    // Выход ems      +          
            new Vector3(316.47, -582.61, 43.28),  // Спавн в больнице после смерти      + 
            new Vector3(306.71, -601.007, 42.28),  // Склад медикаментов, Bdesma Katsuni,Open stock +     
            new Vector3(301.37, -599.40, 42.28),   // Раздевалка,начать рабочий день,Press E,change clothes    +  
            new Vector3(312.34, -592.47, 42.28),  // Начать лечение,Steve Hobs +
            new Vector3(319.54, -569.62, 42.28), // Сведение тату, удаление тату,Billy Bob
            new Vector3(339.0912, -583.9084, 73.04566), // тп на первый этаж из крыши  To hospital              
            new Vector3(331.67, -595.62, 42.28), // Тп на крышу к вертолётам    Yo roof         
        };
        ...
        public void onPlayerDeathHandler(Client player, Client entityKiller, uint weapon)
        {
            try
            {
                ...
                Jobs.spais.Event_PlayerDeath(player, entityKiller, weapon);
