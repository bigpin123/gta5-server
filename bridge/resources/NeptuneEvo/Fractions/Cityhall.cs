...
namespace NeptuneEvo.Fractions
{
    class Cityhall : Script
    {
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("~r~Roman Krov", new Vector3(-534.51, -194.86, 48.42), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~r~Denis Krov", new Vector3(-538.48, -198.07, 48.42), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~o~Приём на работу", new Vector3(-547.99, -191.22, 39.22), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);//Пет работы
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Открыть склад"), new Vector3(CityhallChecksCoords[0].X, CityhallChecksCoords[0].Y, CityhallChecksCoords[0].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Рабочий день"), new Vector3(CityhallChecksCoords[1].X, CityhallChecksCoords[1].Y, CityhallChecksCoords[1].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
                ...
                for (int i = 2; i < 4; i++)
                {
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Нажмите E"), new Vector3(CityhallChecksCoords[i].X, CityhallChecksCoords[i].Y, CityhallChecksCoords[i].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                //Координаты двери открытия сейфа
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Открыть Общий склад"), new Vector3(CityhallChecksCoords[6].X, CityhallChecksCoords[6].Y, CityhallChecksCoords[6].Z + 0.7), 5F, 0.4F, 0, new Color(255, 255, 255));
                //Двери открытие , ненужное
        ...
        {
            new Vector3(-534.51, -194.86, 46.42), // Склад в Мэрии всего +
            new Vector3(-538.48, -198.07, 46.42), // Начать рабочий день, раздевалка + 
            new Vector3(-549.58, -197.16, 58.91), // main door enter + (убрана встену)
            new Vector3(-549.16, -194.43, 54.11), // main door exit - (убрать в стену)
            new Vector3(256.9124, 220.4567, 105.2864), // door 1 +
            new Vector3(265.8495, 218.1592, 109.283), // door 2 +
            new Vector3(-534.90, -192.51, 46.42), // Склад оружия в Мэрии +
        };
