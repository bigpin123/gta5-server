...
namespace NeptuneEvo.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(362, Merryweather.Coords[0], 1.3f, 6, Main.StringToU16("Наёмники"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(455, Manager.FractionSpawns[16], 1, 52, Main.StringToU16("Военный Крейсер"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(184, LSNews.LSNewsCoords[0], 1.2f, 59, Main.StringToU16("News"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallChecksCoords[2], 1.2f, 0, Main.StringToU16("Мэрия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(61, Ems.emsCheckpoints[0], 1.2f, 59, Main.StringToU16("Больница"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(88, Fbi.EnterFBI, 1.2f, 58, Main.StringToU16("FIB"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(60, Police.policeCheckpoints[1], 1.2f, 38, Main.StringToU16("Полиция"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(85, Army.ArmyCheckpoints[2], 1, 28, Main.StringToU16("Доки"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[1], 1.1f, 52, Main.StringToU16("The Families"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[2], 1.1f, 58, Main.StringToU16("The Ballas"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[3], 1.1f, 28, Main.StringToU16("Los Santos Vagos"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[4], 1.1f, 74, Main.StringToU16("Marabunta Grande"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[5], 1.1f, 49, Main.StringToU16("Blood Street"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(685, Manager.FractionSpawns[10], 1.2f, 5, Main.StringToU16("Итальянское ранчо"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(685, Manager.FractionSpawns[11], 1.2f, 4, Main.StringToU16("Русская мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(685, Manager.FractionSpawns[12], 1.2f, 69, Main.StringToU16("Мексиканский картель"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(685, Manager.FractionSpawns[13], 1.2f, 59, Main.StringToU16("Армянская мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(582, Manager.FractionSpawns[14], 1.2f, 52, Main.StringToU16("Армия"), 255, 0, true, 0, 0);
        ...
        public static SortedList<int, Vector3> FractionSpawns = new SortedList<int, Vector3>()
        {
            ...
            {3, new Vector3(478.84, -1881.55, 25.10)},     // Los Santos Vagos
            {4, new Vector3(1443.84, -1492.03, 62.70)},     // Marabunta Grande
            {5, new Vector3(969.51, -1823.35, 31.10)},     // Blood Street
            ...
            {12, new Vector3(-1521.50, 851.42, 182.59)},    // Мексиканский Картель
            {13, new Vector3(-1894.05, 2050.88, 140.93)},    // Armenian Mafia  НПС МАФИИ NPC Mafia
            {14, new Vector3(-2355.625, 3254.189, 33.69071)},    // Army
            {15, new Vector3(-1063.046, -249.463, 44.0211)},    // LSNews
            {16, new Vector3(3006.17, -4530.52, 5.91)},    // Крейсер
        ...
        public static SortedList<int, string> FractionNames = new SortedList<int, string>()
        {
            ...
            {8, "Госпиталь" },
            {9, "FIB" },
            {10, "Итальянская мафия" },
            {11, "Русская мафия" },
            {12, "Мексиканский картель" },
            {13, "Армянская мафия" },
            {14, "Армия" },
            {15, "Новости" },
            {16, "Байкеры" },
    ...
    class Stocks : Script
    {
        ...
        {
            { 1, new Vector3(-220.27, -1617.09, 33.87)},//фемелис
            { 2, new Vector3(118.00, -1962.64, 20.33)},// Баллас
            { 3, new Vector3(478.84, -1881.55, 25.10)}, //Вагос
            { 4, new Vector3(1443.84, -1492.03, 62.70)},//Марабунта
            { 5, new Vector3(963.04, -1841.68, 30.28)},//Бладс
            { 6, new Vector3()}, //Мэрия
            { 7, new Vector3()},//Полиция
            { 8, new Vector3()},//Госпиталь
            { 9, new Vector3()},//ФИБ
            { 10, new Vector3(1404.19, 1138.29, 108.75)}, //склад итальянцев
            { 11, new Vector3(-85.59, 997.91, 229.61)}, //склад русских
            { 12, new Vector3(-1498.32, 836.19, 177.64)}, //склад Мексиканцев
            { 13, new Vector3(-1866.98, 2062.17, 134.43)}, //склад армяне
            { 14, new Vector3()},//Армия
            { 15, new Vector3()},//СМИ
            { 16, new Vector3(976.768738, -103.651985, 73.725174)},//Байкеры
            { 17, new Vector3(2040.175, 3018.278, -73.82208)},// Наёмники
        };
        ...
        { //материалы фракции
            ...
            { 3, new Vector3(463.00, -1894.64, 24.10)},
            { 4, new Vector3(1423.01, -1504.22, 59.95)},
            { 5, new Vector3(974.68, -1844.36, 30.27)},
            { 6, new Vector3(-580.291, -130.4515, 34.00952)},
            { 7, new Vector3(434.195, -1005.593, 26.21062)},
            { 8, new Vector3(341.9803, -562.6921, 27.62378)},
            { 9, new Vector3(173.10, -687.80, 32.13)},//блип материалов FIB
            { 10, new Vector3(1454.94, 1147.10, 113.29)}, //блип материалов Итальянцы
            { 11, new Vector3(-128.7453, 1006.892, 234.6121)}, //блип материалов Русских
            { 12, new Vector3(-1551.52, 880.78, 180.32)}, //блип материалов Мексиканцев
            { 13, new Vector3(-1922.82, 2040.70, 139.73)}, //блип материалов Армяне
            { 14, new Vector3(-2455.718, 2984.414, 31.81033)},
            { 15, new Vector3()},
            { 16, new Vector3(977.316, -133.0648, 72.66093)},
            { 17, new Vector3(2521.35, -311.42, 91.99)}, // TODO:
        };
        ...
        public void fillStocks()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    {
                        data.label = NAPI.TextLabel.CreateTextLabel("~h~", garageCoords[id] + new Vector3(0, 0, 1.5), 10f, 0.4f, 0, new Color(255, 255, 255), true);
                    ...
                    NAPI.Marker.CreateMarker(1, stockCoords[id] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(255, 105, 180)); //цвет блипа склада
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~h~Склад {Manager.getName(id)}"), new Vector3(stockCoords[id].X, stockCoords[id].Y, stockCoords[id].Z + 0.6), 5F, 0.5F, 0, new Color(255, 255, 255));
                    ...
                    NAPI.Marker.CreateMarker(1, garageCoords[id], new Vector3(), new Vector3(), 3f, new Color(155, 18, 255));
                }
            }
        ...
        public class FractionStock
        {
            ...
            public void UpdateLabel()
            {
                ...
                var text = $"~h~";
                if (Drugs > 0) text += $"~b~Наркота: ~w~{Drugs}/10000\n";
                if (Materials > 0) text += $"~b~Материалы: ~w~{Materials}/{maxMats}\n";
                if (Medkits > 0) text += $"~b~Аптеки: ~w~{Medkits}\n";
                label.Text = text;
            }
        }
    }
    ...
    class MatsWar : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                warblip = NAPI.Blip.CreateBlip(478, warPosition, 1, 40, Main.StringToU16("Война за маты"), 255, 0, true, 0, 0); //Блип склада
            }
            catch (Exception e) { Log.Write("ResourceStart: " + e.Message, nLog.Type.Error); }
        }
