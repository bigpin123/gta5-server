...
mp.keys.bind(global.Keys.VK_TAB, false, function () { // E key
...
mp.events.add('render', () => {
	try {
	    ...
	    if (nearestObject != null && (entity == null || entity.type != "object")) {
		    mp.game.graphics.drawText("TAB", [nearestObject.position.x, nearestObject.position.y, nearestObject.position.z], {
			    font: 0,
	            color: [255, 255, 255, 185],
		        scale: [0.4, 0.4],
			    outline: true
